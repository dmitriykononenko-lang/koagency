...
/**
 * Брендовая форма ko:agency.
 * POST /api/lead → сервер создаёт сделку + контакт в amoCRM через API v4.
 */
      ...
      <AnimatePresence mode="wait">
        {status === 'success' ? (
          ...
          >
            ...
            <Field label="ФИО" name="name" type="text" placeholder="Как к вам обращаться" required autoComplete="name" />
            <Field label="Телефон" name="phone" type="tel" placeholder="+7 000 000-00-00" autoComplete="tel" />
