...
const faqs = [
  {
    ...
    answer: 'Стоимость зависит от сложности проекта: базовое внедрение amoCRM от 80 000₽, комплексное решение с AI и интеграциями от 180 000₽. Первый аудит бесплатно — определим точную стоимость под ваши задачи.'
  },
  {
